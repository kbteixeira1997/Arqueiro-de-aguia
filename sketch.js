...
function preload(){
  ...
  shooterImg = loadImage("assets/Shot_1.png")
  shooter_shooting = loadImage("assets/Shot_2.png")

  zombieImg = loadImage("assets/aguia.png")
...
if(keyWentDown("space")){
  bullet = createSprite(displayWidth-1150,player.y-30,10,5)
  bullet.velocityX = 20
...
function enemy(){
  if(frameCount%50===0){
    ...
    zombie = createSprite(random(displayWidth,1100),random(100,500),40,40)
